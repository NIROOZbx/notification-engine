module github.com/NIROOZbx/notification-engine/services/backend
...
require (
	...
	github.com/shareed2k/goth_fiber v0.3.3 // indirect
	github.com/shareed2k/goth_fiber/v2 v2.0.3 // indirect
